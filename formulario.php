        ...
        <div id="blurM"></div>
       	...
       	<div id="optionCa">
            ...
            <center><ul>
                        ...
                        <?php
						echo("<li><a href='formularioF.php?email=".$email."'>Funcionario</a></li>
    ...
    filter: blur(5px);">*/
        ...
        <center><h1>Clientes cadastradros</h1></center>");
            	...
            	echo("<tr>
				  ...
				  while($linha = mysql_fetch_array($consulta)){
					  ...
					  echo("<tr>
						...
						<input name='condicao' type='hidden' value='cli'/></form></td>
						</form></td>
						<td><form name='excluir' action='excluir.php?email=".$email."' method='post' ><input type='submit' ".$botao = 'formularioF.php'." name='excluir' 										value=".$id." id='remover'></form></td>
            ...
            echo(" <script language='javascript' type='text/javascript'>
                    ...
                    //echo("alert(".$linha['nomeCliente'].");");

				 
                //       								if($linha['emailCliente'] == $emailV){

                  //     									echo("alert('O endereço de email ja existe!')");
                    //   									$validaE = 1;
//                       									break;
                       							...
                       							//if($validaE == 0){
													...
													echo("document.getElementById('emailC').style.borderColor='#FFF';
