        ...
        <div id="blurMP"></div>
       	...
       	<div id="optionCa">
            ...
            <center><ul>
						...
						<li><a href='formularioF.php?email=".$email."'>Funcionario</a></li>");
						?>
                ...
                echo("<tr>
                  ...
                  while($linha = mysql_fetch_array($consulta)){
                      ...
                      echo("<tr>
                        ...
                        <td> <form name='editar'  action='#conteudoCa' method='post' ><input type='submit' name='editarP' value=".$id." id='editar'></form></td>
                         <td><form name='excluir' action='excluir.php?email=".$email."' method='post' ><input type='submit' name='excluirS' value=".$id." id='remover'></a></form></td>
